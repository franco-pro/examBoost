export enum DialogText{
    ...
    competition_update_head = "mycompetition.competition.creations_screen.competition_update_head",
    competition_update_body = "mycompetition.competition.creations_screen.competition_update_body",
    competition_update_btn_text = "mycompetition.competition.creations_screen.competition_update_btn_text",
}